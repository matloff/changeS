...
The code here does changepoint detection/estimation for changes in mean,
...
magnitudes.  Both abrupt and gradual changes may be modeled.  Also,
changes in slope and intercept in piecewise linear models can be
analyzed.
...
# Example: Cancer Occurrence Rate

We next consider applying the S-Curve approach to data collected in
women in Sweden on the rates of breast cancer.  There had been
speculation that such rates rise with the onset of menopause
...
abrupt changes, thus gradual overall.  Thus this is a good example use
...
``` r
# simulate a "hockey stick," flat value 1 before 0, slope 1 afterward
x <- (-50):50 
m <- rep(1,101) 
m[1:51] <- 1 
m[52:101] <- 1:50 
y <- m + rnorm(101,sd=0.2) 
...
# b1 -4.610e-04  1.956e-03  -0.236    0.814    
# h1  9.995e-01  2.218e-03 450.646   <2e-16 ***
# s1  3.879e+00  5.190e+01   0.075    0.941    
# c   1.301e+00  9.332e+00   0.139    0.889    
# b2  1.007e+00  5.676e-02  17.738   <2e-16 ***
# h2 -2.555e-02  6.709e-02  -0.381    0.704    
# s2  7.614e+01  4.791e+10   0.000    1.000    
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.2056 on 94 degrees of freedom
# 
# Number of iterations to convergence: 94 
# Achieved convergence tolerance: 1.49e-08

Sure enough, pre-0 slope before 0 was about 0, about 1 afterward, and so
on.  Standard errors very small.
...
* Statistical basis
    ...
    - **mcp** takes the Bayesian philosophy
